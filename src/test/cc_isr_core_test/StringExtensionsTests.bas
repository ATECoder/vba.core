...
''' <returns>   An <see cref="cc_isr_Test_Fx.Assert"/>   instance of <see cref="Assert.AssertSuccessful"/>   True if the test passed. </returns>
Public Function TestDelimitedStringElementShouldPop() As cc_isr_Test_Fx.Assert
    
    Dim p_delimitedString As String: p_delimitedString = "a,b,c"
    
    Set TestDelimitedStringElementShouldPop = cc_isr_Test_Fx.Assert.AreEqual("a", _
    ...
    If TestDelimitedStringElementShouldPop.AssertSuccessful Then
        ...
        Set TestDelimitedStringElementShouldPop = cc_isr_Test_Fx.Assert.AreEqual("b", _
            StringExtensions.Pop(p_delimitedString, ","), _
    ...
    If TestDelimitedStringElementShouldPop.AssertSuccessful Then
        ...
        Set TestDelimitedStringElementShouldPop = cc_isr_Test_Fx.Assert.AreEqual("c", _
            StringExtensions.Pop(p_delimitedString, ","), _
    ...
    If TestDelimitedStringElementShouldPop.AssertSuccessful Then
        ...
        Set TestDelimitedStringElementShouldPop = cc_isr_Test_Fx.Assert.AreEqual(VBA.vbNullString, _
            StringExtensions.Pop(p_delimitedString, ","), _
